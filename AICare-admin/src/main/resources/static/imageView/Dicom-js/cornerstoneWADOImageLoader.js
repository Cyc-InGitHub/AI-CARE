    ...
    "./imageLoader/webWorkerManager.js":
      ...
      (function (module, exports, __webpack_require__) {
        ...
        var defaultConfig = {
          ...
          webWorkerPath: 'http://localhost:80/imageView/Dicom-js/cornerstoneWADOImageLoaderWebWorker.js',
          webWorkerTaskPaths: [],
          taskConfiguration: {
            decodeTask: {
              loadCodecsOnStartup: true,
              initializeCodecsOnStartup: false,
              codecsPath: 'http://localhost:80/imageView/Dicom-js/cornerstoneWADOImageLoaderCodecs.js',
              usePDFJS: false,
