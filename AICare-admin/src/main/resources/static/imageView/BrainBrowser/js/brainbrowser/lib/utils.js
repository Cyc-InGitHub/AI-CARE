  ...
  BrainBrowser.utils = {
    ...
    */
    captureTouch: function(element) {
      ...
      element.addEventListener("touchstart", updateTouches, false);  // 手指放到屏幕上的时候触发
      element.addEventListener("touchmove", updateTouches, false);   // 手指在屏幕上移动的时候触发
      element.addEventListener("touchend", updateTouches, false);    // 手指从屏幕上拿起的时候触发
