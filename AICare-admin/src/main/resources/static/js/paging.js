				...
				if(totalPage <= 10) {
					...
					if((totalPage - 7) > currentPage) {
						...
						if((totalPage - 1) <= currentPage) {
							str = '<li><a  href="javascript:void(0)" style="'+string1+'">' + (totalPage - 6) + '</a></li>';
							arr.push(str);
							str = '<li><a  href="javascript:void(0)" style="'+string1+'">' + (totalPage - 5) + '</a></li>';
							arr.push(str);
							str = '<li><span style="'+string1+'">...</span></li>';
							arr.push(str);
							...
							str = '<li><a  href="javascript:void(0)" style="'+string1+'">' + (currentPage - 4) + '</a></li>';
							arr.push(str);
							str = '<li><a  href="javascript:void(0)" style="'+string1+'">' + (currentPage - 3) + '</a></li>';
							arr.push(str);
							str = '<li><span style="'+string1+'">...</span></li>';
							arr.push(str);
							for(var i = currentPage - 1; i <= currentPage + 1; i++) {
